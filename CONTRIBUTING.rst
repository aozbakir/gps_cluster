...
Welcome to ``gps_cluster`` contributor's guide.
...
If you experience bugs or general issues with ``gps_cluster``, please have a look
...
You can help improve ``gps_cluster`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``gps_cluster`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``gps_cluster``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/gps_cluster.git
    cd gps_cluster
...
#. Install |pre-commit|_::
   ...
   ``gps_cluster`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/gps_cluster
.. _issue tracker: https://github.com/<USERNAME>/gps_cluster/issues
.. <-- end -->
